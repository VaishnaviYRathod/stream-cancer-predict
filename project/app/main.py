...
# #     # Placeholder function, replace with your logic to generate radar chart
...
# #         fill='toself',
# #         name='Worst Value',
# #         line=dict(color='red')  # Set line color
# #     ))
...
# #     input_array = input_data.values.flatten()
...
# #     st.write("Probability of it being benign:", model.predict_proba(input_array_scaled)[0][0])
# #     st.write("Probability of it being malacious:", model.predict_proba(input_array_scaled)[0][1])
